    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='sample.location', verbose_name='Parent')),
            ],
        ),
        migrations.CreateModel(
            name='DemoModel',
            fields=[
                ...
                ('capital', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='capitals', to='sample.location')),
                ('country', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='countries', to='sample.location')),
            ],
        ),
    ]
