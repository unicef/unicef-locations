import pytest
from unicef_locations.serializers import (LocationExportSerializer, GatewayTypeSerializer,
                                          CartoDBTableSerializer, LocationSerializer,
                                          LocationLightSerializer, LocationExportFlatSerializer)
