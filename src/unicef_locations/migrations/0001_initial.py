...
import mptt.fields
import unicef_locations.models
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "display_name",
                    models.CharField(
                        blank=True, max_length=254, null=True, verbose_name="Display Name"
                    ),
                ),
                (
                    "name_col",
                    models.CharField(default="name", max_length=254, verbose_name="Name Column"),
                ),
                (
                    "pcode_col",
                    models.CharField(default="pcode", max_length=254, verbose_name="Pcode Column"),
                ),
                (
                    "parent_code_col",
                    models.CharField(
                        blank=True, max_length=254, null=True, verbose_name="Parent Code Column"
                    ),
                ),
                (
                    "color",
        ...
        migrations.AlterUniqueTogether(
            name="location", unique_together=set([("name", "gateway", "p_code")])
        ),
    ]
