            ...
            fields=[
                ('id',
                 models.AutoField(
                     ...
                     verbose_name='ID')),
                ('domain',
                 models.CharField(max_length=254, verbose_name='Domain')),
                ('api_key',
                 models.CharField(max_length=254, verbose_name='API Key')),
                ('table_name',
                 models.CharField(max_length=254, verbose_name='Table Name')),
                ('display_name',
                 models.CharField(
                     blank=True,
                     max_length=254,
                ...
                ('name_col',
                 models.CharField(
                     default='name',
                     max_length=254,
                     verbose_name='Name Column')),
                ('pcode_col',
                 models.CharField(
                     default='pcode',
                     max_length=254,
                     verbose_name='Pcode Column')),
                ('parent_code_col',
                 models.CharField(
                     blank=True,
                     max_length=254,
